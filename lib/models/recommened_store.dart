...
List<RecommendStore> recommendStoreList = [
  RecommendStore(
      ...
      storeImages: [
        'assets/market_store_1_1.jpg',
        'assets/market_store_1_2.jpg',
      ]),
  RecommendStore(
      storeName: '아미아미주먹밥',
      location: '우동',
      ...
      storeImages: [
        'assets/market_store_2_1.jpg',
        'assets/market_store_2_2.jpg',
      ]),
  RecommendStore(
      storeName: '영어원어민 논술',
      location: '중동',
      ...
      storeImages: [
        'assets/market_store_3_1.jpg',
        'assets/market_store_3_2.jpg',
      ]),
  RecommendStore(
      ...
      storeImages: [
        'assets/market_store_4_1.jpg',
        'assets/market_store_4_2.jpg',
      ])
];
